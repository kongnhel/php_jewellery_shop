   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <option value="" selected disabled>select category</option>
               <?php
                  ...
                  $payment_methods = $conn->query("SELECT id, type FROM category");
      ...
      <div class="inputBox">
         <input type="text" name="quantity" class="box" required placeholder="Enter product quantity" value="<?= $fetch_products['quantity']; ?>">
         </div>
