...
<section class="products">
   ...
   <form action="" class="box" method="POST">
      ...
      <p class="out-of-stock" style="font-size: 18px; color:#222; font-weight:bold;">Out of Stock</p>
      <?php } else { ?>
      <p style="font-size: 12px; margin:10px; color:green;">In stock: <?= $fetch_products['quantity']; ?></p>
      <input type="number" min="1" max="<?= $fetch_products['quantity']; ?>" value="1" name="p_qty" class="qty">
      <input type="submit" value="add to wishlist" class="option-btn" name="add_to_wishlist">
      <input type="submit" value="add to cart" class="btn" name="add_to_cart">  <?php } ?>
   </form>
   <?php
         }
      }else{
